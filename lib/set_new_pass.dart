...
class _SetNewPasswordPageState extends State<SetNewPasswordPage> {
	...
	InputDecoration _decoration({required String hint, required bool show, required VoidCallback onToggle}) {
		String? error;
		if (_submitted) {
		...
		return InputDecoration(
			...
			suffixIcon: IconButton(
				icon: Icon(show ? Icons.visibility_off_outlined : Icons.visibility_outlined, size: 18, color: Colors.black54),
				onPressed: onToggle,
				splashRadius: 18,
			),
							...
							children: [
								...
								SizedBox(
									...
									child: ElevatedButton(
										onPressed: _formValid ? _submit : () => setState(() => _submitted = true),
										style: _btnStyle,
										child: const Text('Update Password', style: TextStyle(fontSize: 14.5, fontWeight: FontWeight.w600)),
									),
								),
